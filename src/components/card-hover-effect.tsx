      ...
      {items.map((item, idx) => {
        ...
        return (
          ...
          >
            ...
            <div className="rounded-md w-full p-4 cursor-pointer overflow-hidden bg-black group-hover:ring-2 ring-green-500 relative z-20 transition-all duration-500">
